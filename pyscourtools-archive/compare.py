...
class Compare:
    ...
    def compare_tests(self, instrument, description=True, x_description=0.78, y_description=0.7, **kwargs) -> Plotter:
        if len(self.tests) == 1:
        ...
        for test in self.tests:
            ...
            plot.plot(inst.time, inst.data, label=test.test_name)
